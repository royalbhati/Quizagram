...
export default class DashNav extends Component {
  ...
  handleRedirect = event => {
    ...
    axios.get(`/api/quiz/${this.state.id}`).then(res => {
      console.log("quiz", res.data);
      // this.props.history.pushState({ msg: "success" }, "/dashboard/takeQuiz");
    });
  };
  render() {
    return (
                    ...
                    <ul class='menu'>
                      ...
                      <li>
                        <label for='drop-2' class='toggle toogle-2'>
                          Examination{" "}
                          <span class='fa fa-angle-down' aria-hidden='true' />
                        </label>
                        <a href='#'>
                          Examination{" "}
                          <span class='fa fa-angle-down' aria-hidden='true' />
                        ...
                        <ul>
                          <li>
                            <a href='#services' class='drop-text'>
                              JEE
                            </a>
                          </li>
                          <li>
                            <a href='faq.html' class='drop-text'>
                              NEET
                            </a>
                          </li>
                          <li>
                            <a href='404.html' class='drop-text'>
                              TCS
                            </a>
                          </li>
                          <li>
                            <a href='#stats' class='drop-text'>
                              CAT
                            </a>
                          </li>
                          <li>
